...
import { Space, Row, Descriptions, Card, Skeleton, Spin } from 'antd';
import {
  WindowsOutlined,
  AppleOutlined,
  AndroidOutlined,
        ...
        {props.showDescription && (
          <Row>
            ...
            >
              ...
              <Descriptions.Item span={4} label="Chemotypes">
                <Space>
                  {props.chemoType.map((fam, idx) => (
