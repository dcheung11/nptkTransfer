...
function GenomeCirclePlot(props) {
  ...
  props.genomeOrfs.map(orf => {
    const heatmapUnit = {
      ...
      start: parseInt(orf.orf_start, 10),
      end: parseInt(orf.orf_stop, 10),
      value: orf.orf_id,
    };
  ...
  props.submissionClusters.map(cluster => {
    clusters.push({
      ...
      start: parseInt(cluster.cluster_start, 10),
      end: parseInt(cluster.cluster_stop, 10),
        ...
        tracks={[
          {
            ...
            config: {
              ...
              tooltipContent: datum => `ORF ID: ${datum.peptide_id}`,
            },
          },
          {
            type: 'HEATMAP',
            ...
            config: {
              ...
              tooltipContent: datum => `BGC ID: ${datum.cluster_id}`,
            },
          },
        ]}
      />
