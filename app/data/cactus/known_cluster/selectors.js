...
const selectClusterDomain = state => state.known_cluster || initialState;

/**
 * Other specific selectors
 */

const makeSelectAllKnownLoading = () =>
  createSelector(
    selectClusterDomain,
    substate => substate.allKnownLoading,
  );

const makeSelectAllKnown = () =>
  createSelector(
    selectClusterDomain,
    substate => substate.allKnown,
  );
