...
export function fetchAllKnown(bearerData) {
  return {
    type: FETCH_ALL_KNOWN,
    bearerData,
  };
}

export function successAllKnown(knownData) {
  return {
    type: SUCCESS_ALL_KNOWN,
    knownData,
  };
}

export function failedAllKnown(err) {
  return {
    type: FAILED_ALL_KNOWN,
    err,
  };
}
