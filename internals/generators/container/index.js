...
module.exports = {
  ...
  actions: data => {
    // Generate index.old.js and index.test.js
    const actions = [
      {
        type: 'add',
        path: '../../app/containers/{{properCase name}}/index.old.js',
        templateFile: './container/index.old.js.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
    ...
    // If they want actions and a reducer, generate constants.js, constants.js,
